...
void Shader::setMaterial(Material& material) {
    ...
    /*
     *  ka,ks,kd 설정하고 texture 매핑!!
     *
     */
    setUniform("Ka",material.ambient);
    setUniform("Ks",material.specular);
    setUniform("Kd",material.diffuse);
    setUniform("Ke",material.emission);
    setUniform("sh",material.shininess);
    setTexture("diffuse_map",material.diffusemap.textureID,0); //glactivetexture 로 확인하고 넣기
...
void Shader::setLight(Light& light) {
     ...
     */
    setUniform("lightdir",light.srcpos);
...
void Shader::setCamera(Camera& camera) {
    ...
    setUniform("worldMat",glm::mat4x4(1.0)); // 바꾸기
